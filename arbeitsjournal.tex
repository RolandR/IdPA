...
% SOURCE
% http://vis4.net/blog/posts/javascript-quelltexte-in-latex/
...
% SOURCE
% http://www.golatex.de/wie-css-quellcode-formatieren-listings-t4003.html
...
\ref{fig:gensquare} \glqq \nameref{fig:gensquare}\grqq dargestellt.
...
\lstinputlisting{code/table.html}
...
\begin{figure}[h!]
  \centering
  \includegraphics[width=0.95\textwidth]{preparePassword.pdf}
...
\includepdf[pages=-]{wikipedia.pdf}
